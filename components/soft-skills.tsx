...
export default function SoftSkills() {
  ...
  const getSkillColor = (skill: string) => {
    ...
    if (mindsetSkills.includes(skill)) {
      return "bg-purple-200 dark:bg-purple-900/40 text-purple-900 dark:text-purple-100"
      ...
      return "bg-pink-200 dark:bg-pink-900/40 text-pink-900 dark:text-pink-100"
    }
